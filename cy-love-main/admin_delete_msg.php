<?php
    ...
    try {
        ...
        // vérifie si l'ID du msg est passé en POST
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ID_msg'])) {
            $ID_msg = $_POST['ID_msg'];
            // Supprimer le msg
            $delete_sql = "UPDATE messages SET Supprimé = 'oui' WHERE ID_msg = :id";
            ...
            $response['message'] = "Message supprimé avec succès (ID: " . $ID_msg . ").";
            ...
            $response['message'] = "Erreur lors de la suppression du message : " . $e->getMessage();
            echo json_encode($response);
            exit;
        }
